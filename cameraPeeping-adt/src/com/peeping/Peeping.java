...
public class Peeping extends Activity implements SurfaceHolder.Callback,PreviewCallback{
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		switch (keyCode) {
			...
			if(CAMERA_VALUE == 0){
				Toast.makeText(Peeping.this, "后置摄像头...", Toast.LENGTH_SHORT).show();
				Log.e(TAG,"back camera is seleted");
			}else {
				Toast.makeText(Peeping.this, "前置摄像头...", Toast.LENGTH_SHORT).show();
		...
		case KeyEvent.KEYCODE_VOLUME_UP:
			...
			if(camera != null){
				...
				Toast.makeText(Peeping.this, String.valueOf(bitrate_factor) + "倍标准码流...", Toast.LENGTH_SHORT).show();
